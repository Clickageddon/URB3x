...
pygame.display.set_caption("le vrai urb3x de la mortadelance vive unchained le goat de steal a brainrot")
...
# background.png = ville noir et blanc ; background2.png = breakthrough, background3.png = nullscapes
...
"00000P000000000000000000000000",
